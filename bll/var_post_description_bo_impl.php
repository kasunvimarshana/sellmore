<?php
class var_post_description_bo_impl implements bll_class{
    
    private $dev_date;
    private $dao_implement_obj;
	function __construct(){
		$this->dao_implement_obj = new var_post_description_dao_impl();
    ...
    */
	public function f_insert($param){
        if (!($param instanceof var_post_description)){
