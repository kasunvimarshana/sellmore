<?php
class var_event extends common_object_class{
    
    private const VAR_TABLE_NAME = "var_event";
    private const VAR_TABLE_COLUMN = array(
        ...
        ["key"=>"var_trigger", "key_dt"=>DB_CON::PARAM_STR],
        ["key"=>"var_action", "key_dt"=>DB_CON::PARAM_STR],
