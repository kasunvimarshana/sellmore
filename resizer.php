...
{
	include_once(META_CON::VAR_BASE_DIR.DIRECTORY_SEPARATOR."php_lib".DIRECTORY_SEPARATOR."PHPImageResizer".DIRECTORY_SEPARATOR."resizer".DIRECTORY_SEPARATOR."components".DIRECTORY_SEPARATOR."pjImage.component.php");
